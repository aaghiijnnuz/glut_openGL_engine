...
void draw_pavilion() {
	...
	glRotatef(-90, 1, 0, 0);
	glutSolidCone(0.6, 0.25	, 4, 3);
	glPopMatrix();

	//屋顶第二层
	glPushMatrix();
	glColor3f(0, 1,0);
	glTranslated(0.0f, 0.1f+h, 0.0f);
	glRotatef(-90, 1, 0, 0);
	glutSolidCone(0.42, 0.2, 4, 3);
	glPopMatrix();

	//屋顶第三层
	glPushMatrix();
	glColor3f(0, 0, 1);
	glTranslated(0.0f, 0.2f+h, 0.0f);
	glRotatef(-90, 1, 0, 0);
	glutSolidCone(0.25, 0.15, 4, 3);
	glPopMatrix();
	
	//屋顶圆球
	glPushMatrix();
	glColor3f(1, 0, 1);
	glTranslated(0.0f, 0.37f+h, 0.0f);
	glRotatef(-90, 1, 0, 0);
	...
	glPushMatrix();
	glColor3f(1, 1, 0);
	glTranslated(0.0f, 0.34f+h, 0.0f);
	glRotatef(31, 1, 0, 0);
	gluCylinder(cylinder_obj1, 0.02, 0.02, 0.7, 10, 10);
	glTranslated(0.0f, 0.0f, 0.7f);
	gluDisk(cylinder_obj2, 0, 0.02, 10, 10);
	glPopMatrix();
	...
	glPushMatrix();
	glColor3f(0, 1, 1);
	glTranslated(0.0f, 0.0f+h, 0.55f);
	glRotatef(90, 1, 0, 0);
	gluCylinder(cylinder_obj1, 0.03, 0.03, 0.7, 10, 10);
	glTranslated(0.0f, 0.0f, 0.7f);
	gluDisk(cylinder_obj2, 0, 0.03, 10, 10);
	glPopMatrix();
	...
	glPushMatrix();
	glColor3f(0, 1, 1);
	glTranslated(0.55f, 0.0f + h, 0.0f);
	glRotatef(90, 1, 0, 0);
	gluCylinder(cylinder_obj1, 0.03, 0.03, 0.7, 10, 10);
	glTranslated(0.0f, 0.0f, 0.7f);
	gluDisk(cylinder_obj2, 0, 0.03, 10, 10);
	...
	glPushMatrix();
	glColor3f(1, 0, 1);
	glTranslated(0.0f, -0.75f + h, 0.0f);
	glRotatef(45, 0, 1, 0);
	glScalef(1,0.1,1);
	glutSolidCube(1);
	glPopMatrix();
	...
	glPushMatrix();
	glColor3f(0, 1, 0);
	glTranslated(-0.23f, -0.5f + h, 0.0f);
	glRotatef(90, 1, 0, 0);
	gluCylinder(cylinder_obj1, 0.01, 0.01, 0.23, 10, 10);
	glTranslated(0.0f, 0.0f, 0.23f);
	gluDisk(cylinder_obj2, 0, 0.01, 10, 10);
	glPopMatrix();
	...
	glPushMatrix();
	glColor3f(0, 1, 0);
	glTranslated(0.0f, -0.5f + h, 0.23f);
	glRotatef(90, 1, 0, 0);
	gluCylinder(cylinder_obj1, 0.01, 0.01, 0.23, 10, 10);
	glTranslated(0.0f, 0.0f, 0.23f);
	gluDisk(cylinder_obj2, 0, 0.01, 10, 10);
	...
	glPushMatrix();
	glColor3f(1, 1, 0);
	glTranslated(0.0f, -0.45f + h, 0.0f);
	...
	glTranslated(0.0f, -0.0f + h, 0.0f);
	glRotatef(90, 1, 0, 0);
	glutSolidCone(0.05, 0.05, 4, 3);
	glPopMatrix();

	//灯
	glPushMatrix();
	glColor3f(1, 1, 1);
	glTranslated(0.0f, -0.07f + h, 0.0f);
